...
- 🧬 [breast-cancer-subtype-classifier](https://github.com/Gsb057/breast-cancer-subtype-classifier) — an ML pipeline classifying breast cancer PAM50 subtypes from RNA-seq data, with independent external validation on a second public cohort
- 📚 Relearning and strengthening core Python/bioinformatics fundamentals through small applied projects (see [Mini-projects](https://github.com/Gsb057/Mini-projects) and [bio-pipe](https://github.com/Gsb057/bio-pipe))
